...
# v, a, b, c = x0
# x0 = np.array([v*20, a*50, b*50, c*10**5])
...
v, a, b, c = optimization_result.x

optimal_x = np.array([v*20, a*50, b*50, c*10**5])
...
optimal_obj = objective_function(optimization_result.x)
